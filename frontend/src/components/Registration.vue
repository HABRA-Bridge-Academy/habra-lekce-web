            ...
            <v-card>
              ...
              <v-form @submit.prevent="submit">
                <v-card-text>
                  ...
                  <v-text-field label="Příjmení" name="surname" v-model="surname" :rules="nameRules" required
                    density="comfortable" :error-messages="errorMessages.name"
                    @input="errorMessages.surname = ''"></v-text-field>

                  <v-text-field label="Email" name='Email' v-model="Email" required density="comfortable"
                ...
                <v-card-actions>
                  ...
                  <div class="flex-gap">
                    Máte účet?
                    <RouterLink :to="{ name: 'login' }">Přihlaste se</RouterLink>
                  </div>
                  <v-spacer></v-spacer>
